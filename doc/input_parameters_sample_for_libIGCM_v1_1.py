...
# -------------------------------------------------------------------------------------------------------------------
## Path/Filename
path_and_filename = '/data/jservon/IPSL_DATA/SIMULATIONS/p86caub/IGCM_OUT/IPSLCM6/PROD/piControl/CTLCM6/ATM/Analyse/SE/CTLCM6_SE_2510_2519_1M_histmth.nc'
#path_and_filename = '/data/jservon/IPSL_DATA/SIMULATIONS/p86jser/IGCM_OUT/IPSLCM5A/DEVT/historical/Cplv5G001/ATM/Analyse/SE/Cplv5G001_SE_1990_1999_1M_histmth.nc'
...
## Simulation description mapping
...
## ModelTrackingDate
SimTrackingDate = time.ctime(os.path.getmtime(path_and_filename))
